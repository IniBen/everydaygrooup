<template>
  <div>
    <div>
      <section class="w-full px-6 pb-12 antialiased bg-white bg3">
        ...
        <div class="mx-auto max-w-7xl">
              ...
              >
                <span
                  class="
                    ...
                    logo
                  "
                  >NewDevz<span class="text-indigo-500">.</span></span
                >
            ...
            >
              <div class="flex items-center justify-start w-1/4 h-full pr-4">
                <a href="#_" class="inline-block py-4 md:py-0">
                  <span
                    class="p-1 text-xl font-black leading-none text-gray-900"
                    ><span>NewDevz</span
              ...
              <div
                ...
                "
                x-bind:class="{ 'flex fixed': showMenu, hidden: !showMenu }"
              >
                <div
                  class="
                    flex-col
                  ...
                  >
                    ...
                    <a
                      ...
                      class="
                        ...
                        text-white
                        bg-indigo-600
                        md:px-3 md:w-auto md:rounded-full
                        lg:px-5
                        hover:bg-indigo-500
                        focus:outline-none
                        md:focus:ring-2
                        focus:ring-0 focus:ring-offset-2 focus:ring-indigo-600
                      "
                      >Sign Up</a
                    >
                  </div>
          ...
          >
            <h1
              ...
              "
            >
              <span class="inline md:block">Start Crafting Your
</span>
              <span
                class="
                  relative
            ...
            <div class="flex flex-col items-center mt-12 text-center">
              ...
              <a href="#" class="mt-3 text-sm text-indigo-500">{{nLt}}</a>
            </div>
          </div>
...
export default {
  name: "HeaderOne",
  props: ['nHt1','nHt2', 'nLt', 'nPrt1', 'nHt3']
};
</script>
